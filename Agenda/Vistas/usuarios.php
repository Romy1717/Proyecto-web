		...
		$i = $i + 1;
			...
			<tr>
				...
				if($v["foto"] != "")
					...
					echo '<img src="Vistas/imgs/anonimo.jpg" class="img-thumbnail" width="40px">';
				echo '
				</td>
				<td> ';
					echo $v["rol"];
	...
	<form role="form" method="post" enctype="multipart/form-data">
		<div class="box-body">
			...
			<div class="form-group">
				...
				<input type="password" class="form-control" name="contra" placeholder="Escribe la contraseña" aria-				label="usuario" aria-describedby="basic-addon1">
			</div></div>
			<!-- rol -->
			<div class="form-group">
				<div class="input-group mb-3">
			...
			<div class="form-group">
				...
				<img src="Vistas/imgs/anonimo.jpg" class="img-thumbnail preview" width="100px">
			</div>
		</div>
	</form>
      </div>
