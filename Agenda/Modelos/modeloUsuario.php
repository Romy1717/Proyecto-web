<?php
	...
	class ModeloUsuarios {
		...
		static public function registrarUsuario($datos) {
			$s = Conexion::conectar()->prepare("INSERT INTO usuarios (rol, nombre, usuario, contra, foto) VALUES (:perfil, :nombre, :usuario, :contra, :foto)");
			$s->bindParam(":perfil", $datos["perfil"], PDO::PARAM_STR);
